...
I'm a forward-thinking computer science student at [Virginia Tech](https://www.vt.edu/), driven by a passion for programming, big data, and machine learning. My academic pursuits blend seamlessly with my professional endeavors, where I currently tackle challenges in an SMS anti-spam project and explore a multitude of technologies.
...
- **Data Visualization**: My visualization of our team progress. The graph represents the classification and content of our SMS test dataset [interactive visualizations using Python Plotly](link-to-your-plotly-visualization).
...
## 🎓 Academic Journey
Studying computer science at [Virginia Tech](https://www.vt.edu/), I'm immersed in the fascinating world of technology. My academic interests are fueled by a desire to explore NLP models, classification algorithms, and the ever-evolving field of machine learning.
